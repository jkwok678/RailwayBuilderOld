...
public:
    ...
    std::shared_ptr<StraightTrack> getStraightTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<DirectTrack> getDirectTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<CurvedTrack> getCurvedTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<LinkedTrack> getLinkedTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<ExitTrack> getExitTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<BufferTrack> getBufferTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<SignalTrack> getSignalTrack(int finalX,int finalY);
    ...
    std::shared_ptr<BridgeUnderpassTrack> getBridgeUnderpassTrack(int finalX,int finalY);
    ...
    std::shared_ptr<SwitchTrack> getSwitchTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<CrossoverTrack> getCrossoverTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<FlyoverTrack> getFlyoverTrackAt(int finalX,int finalY);
    ...
    std::shared_ptr<NamedLocation> getNamedLocarionAt(int finalX,int finalY);
    ...
    std::shared_ptr<Concourse> getConcourseAt(int finalX,int finalY);
    ...
    std::shared_ptr<Parapet> getParapetAt(int finalX,int finalY);
